...
parties_to_be_analysed=['zigma', 'safira','jak','T R THREADS','hillson','SI INTERPACK','K.K. HOSIERY MATERIAL STORE', 'CHIRAG CREATIONS','FANTAIL']
#This party list is being for shortening the party name and make the group common under one name
...
#     ##### Rename
df_OrderHistory_date_and_party_filtered['Party'] = (          ##### May be deleted if PARTY name need not to be renamed or grouping is not required
