...
print(sorted_df4.columns)
# Left Y-axis (Blue)
ax1.plot(sorted_df4['Color'][0:size_plot], sorted_df4['Sum_order'][0:size_plot], color='blue', marker='o', linewidth=2, label='Order_percentage')
ax1.set_xlabel('Shade')
ax1.set_ylabel('Order_Qty (cones)', color='blue')
...
strinn="Shade vs sum of order Qty and order count of "+str(article_list[0]) + " article"
plt.title(strinn)
plt.grid(True)
plt.show()