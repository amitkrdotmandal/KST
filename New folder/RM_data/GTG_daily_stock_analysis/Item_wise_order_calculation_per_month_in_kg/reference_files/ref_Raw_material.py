...
file_name_1 = "OrderHistory.xlsx"
# file_name_1 = "OrderHistory_all_ref.xlsx"
file_dry_weight = "combined_dry_weight_DB.xlsx"
...
for i in range(len_df_dry_weight):
    ...
    a = search_by_raw_material_name_function(file_name_1, file_dry_weight, item_name, input_article_number)
...
# df_cleaned_data.to_excel("temporary_output_WithOut_ply.xlsx")
