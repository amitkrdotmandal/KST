...
Aug_month_adjustment=0 # 1 or 0 as current month is august month (8) not 30 days covered , part of code needs to be deleted
...
for month_no in month_nos_list:
    ...
    ####Delete this part starts
    ####Delete this part starts

    if Aug_month_adjustment==1:
        if month_no==8:
            DDAYS=17
            df_OrderHistory_t_2['total_Odr_Qnty_in_KG_for_item']=df_OrderHistory_t_2['total_Odr_Qnty_in_KG_for_item']/DDAYS*30
            df_OrderHistory_t_2['total_BW_Odr_Qnty_in_KG_for_item'] = df_OrderHistory_t_2[
                                                                       'total_BW_Odr_Qnty_in_KG_for_item'] / DDAYS * 30
    ####Delete this part ends
    ####Delete this part ends
...
df_month_combined_Odr.to_excel('OUTPUT_month_wise_Ord(KG)_WITH_ply.xlsx', index=False)
