...
def order_planning_calculation_upgrade_Upgrade_func(Article_no_to_plan,Shade_to_plan,Qty_to_plan_in_no_for_cones_or_box,Order_already_punched_in_PDMS):
    ...
    if Adjusted_no_of_cone_or_boxes_in_finish < 0:
        Qty_to_plan_in_no_for_cones_or_box_After_Finish_CheckUp = Qty_to_plan_in_no_for_cones_or_box - (
            -1) * Adjusted_no_of_cone_or_boxes_in_finish
    else:
        Qty_to_plan_in_no_for_cones_or_box_After_Finish_CheckUp = Qty_to_plan_in_no_for_cones_or_box
    ...
    if Order_already_punched_in_PDMS == 1:
        ...
        finish_stock_weight_accdg_to_item_name = 0
    if not match.empty:
        finish_stock_weight_accdg_to_item_name = finish_stock_weight_accdg_to_item_name + match.iloc[0][
            'total_prod_req_in_KG']
    ...
    print('Qty_to_plan_in_KG_for_cones_or_box_After_Finish_CheckUp',
          Qty_to_plan_in_KG_for_cones_or_box_After_Finish_CheckUp)
...
# Qty_to_plan_in_no_for_cones_or_box = 100
# Order_already_punched_in_PDMS = 0  ### If already punched '1', if not already punched '0'
# a=order_planning_calculation_upgrade_Upgrade_func(Article_no_to_plan,Shade_to_plan,Qty_to_plan_in_no_for_cones_or_box,Order_already_punched_in_PDMS)
# print(a)