...
data_to_return=[item_name ,total_order_for_item_per_month_in_kg ,total_order_for_item_for_BW_per_month_in_kg
        ,total_order_for_item_WITHOUT_BW_per_month_in_kg]
