...
def search_by_raw_material_name_function(file_name_1,file_dry_weight,item_name,input_article_number):
    ...
    ####   FOR regex
    ####   FOR regex
    item_name = re.sub(r' BONDED', '', item_name)
    ...
    ####   FOR regex
    ####   FOR regex
    df_dry_weight['Item Mapped'] = df_dry_weight['Item Mapped'].str.replace(r' BONDED', '',
                                                                                                    regex=True)
