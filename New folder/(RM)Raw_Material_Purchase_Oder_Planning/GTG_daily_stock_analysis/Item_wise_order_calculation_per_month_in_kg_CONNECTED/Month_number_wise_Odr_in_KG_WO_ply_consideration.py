...
df_month_combined_Odr['total_order_for_item_per_month_in_kg'] =df_month_combined_Odr['Total_order_of_all_months']/((num_of_columns_in_df_month_combined_Odr-1)/2)
df_month_combined_Odr.rename(columns={'Item Mapped': 'item mapped'}, inplace=True)

df_month_combined_Odr.to_excel('Output_WithOut_ply_DB.xlsx', index=False)
