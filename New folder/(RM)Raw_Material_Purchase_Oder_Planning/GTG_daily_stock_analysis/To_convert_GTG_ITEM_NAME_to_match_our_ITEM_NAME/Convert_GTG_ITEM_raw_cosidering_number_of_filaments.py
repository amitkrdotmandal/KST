...
for i in range(len_of_data_RAW):
    ...
    list_first_digit_count=['CONTINOUS POLYESTER FILAMENT  5GPD ','HI-TENACITY NYLON 6 YARN','HI-TENACITY NYLON 6 YARN ','HI-TENACITY NYLON 66 YARN','HT CONTINOUS POLYESTER FILAMENT','LMY NYLON','LMY POLYESTER','POLY POLY CORE SPUN','SHT CONTINOUS POLYESTER FILAMENT','SPUN POLYESTER YARN','TEXTURISED POLYESTER'] ##### may need to change
...
file_name_to_save_all_data='OUTPUT_converted_GTG_foR_RAW_WITH_No_of_filaments.xlsx'
